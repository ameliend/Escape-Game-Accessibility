...
$(document).ready(function () {
    ...
    $("#cliquezIci").click(function (event) {
        ...
        $("#messageBravo").html(`
            ...
            La population est de plus en plus vieillisante en France. D'ici à 2050 plus de 650 millions de personnes auront plus de 60 ans. <br> L'accessibilité impose d'avoir des composants cliquables suffisamment larges pour permettre d'être facilement atteints. <br>
            Indice de Claude : 9 min
        `).fadeIn();
